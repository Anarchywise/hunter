package com.hunter.oauth.service.impl;

import com.hunter.oauth.service.LoginService;
...
public class LoginServiceImpl implements LoginService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret, String grandType) {
        ...
        if(Objects.isNull(choose)) System.out.println("choose is null");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(passwordEncoder.encode("198105"));
    }
}
